...
<form action="" method="post" enctype="multipart/form-data">
 <div class="form-outline w-50 m-auto">
   <label for="product_title" class="form-label"><font size="4">Product Title</font></label>
...
<div class="form-outline w-50 m-auto">
   <label for="product_desc" class="form-label"><font size="4">Product Description</font></label>
...
<div class="form-outline w-50 m-auto mb-4">
   <label for="product_keywords" class="form-label"><font size="4">Product Keywords</font></label>
...
<label for="product_category" class="form-label"><font size="4">Product Categories</font></label>
...
<label for="product_brands" class="form-label"><font size="4">Product Brands</font></label>
...
<div class="form-outline w-50 m-auto mb-4">
   <label for="product_image1" class="form-label"><font size="4">Product Image1</font></label>
...
<div class="form-outline w-50 m-auto mb-4">
   <label for="product_image2" class="form-label"><font size="4">Product Image2</font></label>
  ...
  <div class="form-outline w-50 m-auto mb-4">
   <label for="product_image3" class="form-label"><font size="4">Product Image3</font></label>
...
<div class="form-outline w-50 m-auto mb-4">
   <label for="product_price" class="form-label"><font size="4">Product Price</font></label>
...
if(isset($_POST['edit_product'])){
 ...
 //checking fot fields empty or not
	...
	echo"<script>alert('Please fill all the fields and continue the process')</script>";
	  ...
	  $update_products="update products set product_title='$product_title',product_description='$product_desc',product_keywords='$product_keywords',
						 ...
						 product_image3='$product_image3',product_price='$product_price' where product_id=$edit_id";
