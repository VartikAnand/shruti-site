  ...
  <tbody>";
						...
						?>
									...
									<tr>
										...
										<td><img src="./admin_area/product_images/
		<?php echo  $product_image1 ?>" alt="" class="cart_img"></td>
										...
										<td>
											<!--<button class="bg-dark text-light px-3 py-2 border-0 mx-3">Update</button>-->
						...
						<?php     }
							...
							echo "<h2 class='text-center' style='margin-top:5%'>Your Cart is empty</h2>";
						}
						?>
    ...
    <input type='submit' value='Continue Shopping' class='bg-dark text-light px-3 py-2 border-0 mx-3' name='continue_shopping'>
  
   <button class='bg-dark  px-3 py-2 border-0'> <a href='./user_area/checkout.php' class='text-decoration-none text-light'>Checkout</a></button>";
					} else {

						echo "<input type='submit' value='Continue Shopping' class='bg-dark px-3 py-2 border-0 m-auto text-light' name='continue_shopping'>";
					}
	...
	<!-- last child -->
	<!--include footer-->
	<div class="p-3   text-dark text-center" style="margin-top:15%">
